...
<head>
    ...
    <!-- Page Title  -->
    <title>Home | Pengajuan Judul TA</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-white npc-landing ">
    <div class="nk-app-root">
        ...
        <div class="nk-main ">
                        ...
                        <div class="row flex-lg-row-reverse align-items-center justify-content-between g-gs">
                            ...
                            <div class="col-lg-6 col-md-10">
                                <div class="header-caption">
                                    <h1 class="header-title fw-medium">Ajukan Tugas Akhir Lebih Mudah</h1>
                                    <div class="header-text">
                                        <p>Sistem ini bertujuan untuk memudahkan kamu mengajukan tugas akhir kepada
                                            kepala program studimu. </p>
                                    </div>
                                    <ul class="header-action btns-inline">
                                        <li><a href="login.php" class="btn btn-primary btn-lg btn-round"><span>Ajukan
                                                    Sekarang!</span></a></li>
                                    </ul>
                                </div><!-- .header-caption -->
                            </div><!-- .col -->
                    ...
                    <div class="row justify-content-center text-center">
                        <div class="col-xl-7 col-md-8">
                            <div class="section-head">
                                <h2 class="title text-dark">Dengan semua fitur yang kamu butuhkan</h2>
                                <p>Solusi untukmu dalam pengajuan tugas akhir semakin cepat, dengan ini kamu bisa
                                    monitoring status judul mu
                                </p>
                            </div><!-- .section-head -->
                        </div><!-- .col -->
                    </div><!-- .row -->
			...
			L461.9,492.6z" />
                                        ...
                                        <div class="service-text">
                                            <h5 class="title text-dark">Advanced Statistics</h5>
                                        </div>
                                    </div>
                                </div><!-- .service -->
                            </div><!-- .col -->
		...
		C231.2,268.8,234.9,272.5,239.5,272.5z" />
                                        ...
                                        <div class="service-text">
                                            <h5 class="title text-dark">Method Dice coefisien</h5>
                                        </div>
                                    </div><!-- .service -->
                                </div>
                            </div><!-- .col- -->
                            <div class="col-mb-6 col-lg-4">
                                <div class="card card-full service service-s4 after-bg-danger">
                                    <div class="card-inner">
                                        <div class="service-icon styled-icon styled-icon-6x text-danger">
                                            <svg x="0px" y="0px" viewBox="0 0 512 512" style="fill:currentColor" xml:space="preserve">
	...
	C369.9,213.2,370,213.3,370.1,213.4z" />
                                        ...
                                        <div class="service-text">
                                            <h5 class="title text-dark">Security Updates</h5>
                                        </div>
                                    </div>
                                </div><!-- .service -->
                            </div><!-- .col -->
            ...
            <footer class="footer bg-dark is-dark">
                <div class="container">
                    <div class="row g-gs justify-content-between py-4 py-md-6">
                        <div class="col-lg-4 col-md-6">
                            <div class="widget widget-about mt-n2">
                                ...
                                <p>We denounce with righteous indignation and dislike men who are so beguiled and demora
                                    lized by the charms of pleasure.</p>
                            </div>
                        </div><!-- .col -->
                    ...
                    <div class="row g-3 align-items-center justify-content-md-between py-4">
                        <div class="col-md-8">
                            <div>Copyright &copy; 2022 Dashlite. Template Made by <a class="text-base fw-bold" href="#">Softnio</a></div>
                        </div><!-- .col -->
